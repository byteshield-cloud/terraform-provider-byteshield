...
import (
	"encoding/json"
	"fmt"
	"github.com/byteshield-cloud/golang.api.sdk.v5/core"
...
func (sdk *Sdk) payload(method string, reqParams *ReqParams) {
	...
	reqParams.Headers["X-Auth-Sdk-Version"] = Version
...
func (sdk *Sdk) initDefault() bool {
	sdk.clientIp = ""
	sdk.userAgent = "Sdk " + Version + "; " + runtime.Version() + "; arch/" + runtime.GOARCH + "; os/" + runtime.GOOS
	return true
}
