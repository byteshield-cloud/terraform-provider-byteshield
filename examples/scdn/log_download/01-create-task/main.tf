...
output "task_id" {
  ...
  value       = byteshield_scdn_log_download_task.example.task_id
}

output "status" {
  description = "Task status"
  value       = byteshield_scdn_log_download_task.example.status
}

output "download_url" {
  description = "Download URL (available when task is completed)"
  value       = byteshield_scdn_log_download_task.example.download_url
}
