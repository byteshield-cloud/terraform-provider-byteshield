...
data "byteshield_scdn_log_download_fields" "example" {
...
output "configs" {
  ...
  value       = data.byteshield_scdn_log_download_fields.example.configs
}
...
output "ng_download_fields" {
  ...
  value = [
    for config in data.byteshield_scdn_log_download_fields.example.configs : config.download_fields
