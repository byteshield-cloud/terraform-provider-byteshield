...
data "byteshield_scdn_certificates" "example" {
  page        = 1
  per_page    = 20
...
output "total" {
  ...
  value       = data.byteshield_scdn_certificates.example.total
}

output "issuer_list" {
  description = "List of issuers"
  value       = data.byteshield_scdn_certificates.example.issuer_list
}

output "certificates" {
  description = "List of certificates"
  value       = data.byteshield_scdn_certificates.example.certificates
}

output "certificate_count" {
  description = "Number of certificates returned"
  value       = length(data.byteshield_scdn_certificates.example.certificates)
}
