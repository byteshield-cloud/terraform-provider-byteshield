...
2. Fill in your ByteShield API credentials, certificate ID, and new certificate name
...
- To update certificate content (ca_cert and ca_key), you need to:
  1. Import the existing certificate resource first: `terraform import byteshield_scdn_certificate.example <certificate_id>`
