...
# This example demonstrates how to import existing ByteShield SCDN resources into Terraform
...
# Domain Resource
# ============================================================================
# To import: terraform import byteshield_scdn_domain.example <domain_id>
# Example: terraform import byteshield_scdn_domain.example 102008
...
# ============================================================================
# To import: terraform import byteshield_scdn_origin_group.example <origin_group_id>
# Example: terraform import byteshield_scdn_origin_group.example 85
# Note: The origins block below is a placeholder. After import, run
#       'terraform show' to see the actual configuration and update this file.
...
# ============================================================================
# To import: terraform import byteshield_scdn_certificate.example <certificate_id>
# Example: terraform import byteshield_scdn_certificate.example 456
...
# ============================================================================
# To import: terraform import byteshield_scdn_cert_binding.example "<domain_id>:<certificate_id>"
# Example: terraform import byteshield_scdn_cert_binding.example "123:456"
...
# Origin Resource
# ============================================================================
# To import: terraform import byteshield_scdn_origin.example <origin_id>
...
output "imported_cert_binding" {
  ...
  value = length(byteshield_scdn_cert_binding.example) > 0 ? {
    domain_id = byteshield_scdn_cert_binding.example[0].domain_id
    ca_id     = byteshield_scdn_cert_binding.example[0].ca_id
  } : null
}

output "imported_origin" {
  description = "Imported origin (if imported)"
  value = length(byteshield_scdn_origin.example) > 0 ? {
    id        = byteshield_scdn_origin.example[0].id
    domain_id = byteshield_scdn_origin.example[0].domain_id
  } : null
}
...
output "import_instructions" {
  ...
  value       = <<-EOT
    ...
    1. Domain:
       terraform import byteshield_scdn_domain.example ${var.domain_id_to_import != null ? var.domain_id_to_import : "<domain_id>"}
    
    2. Origin Group:
       terraform import byteshield_scdn_origin_group.example ${var.origin_group_id_to_import != null ? var.origin_group_id_to_import : "<origin_group_id>"}
    
    3. Certificate:
       terraform import byteshield_scdn_certificate.example ${var.certificate_id_to_import != null ? var.certificate_id_to_import : "<certificate_id>"}
    
    4. Certificate Binding (if both domain_id and certificate_id are set):
       terraform import byteshield_scdn_cert_binding.example[0] "${var.domain_id_for_cert_binding != null ? var.domain_id_for_cert_binding : "<domain_id>"}:${var.certificate_id_for_binding != null ? var.certificate_id_for_binding : "<certificate_id>"}"
    
    5. Origin (if both origin_id and domain_id are set):
       terraform import byteshield_scdn_origin.example[0] ${var.origin_id_to_import != null ? var.origin_id_to_import : "<origin_id>"}
