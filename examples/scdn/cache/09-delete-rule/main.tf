...
# This is different from disabling a rule (which uses byteshield_scdn_cache_rule_status resource).
...
# This will permanently delete the cache rule from the ByteShield SCDN system.
