...
```bash
terraform init
terraform import byteshield_scdn_cache_rule.example <business_id>-<business_type>-<rule_id>
# Example: terraform import byteshield_scdn_cache_rule.example 1246-tpl-3009
```
