...
resource "byteshield_scdn_user_ip_item" "item1" {
  user_ip_id = byteshield_scdn_user_ip.list.id
  ip         = "1.1.1.1"
  remark     = "First IP"
}

resource "byteshield_scdn_user_ip_item" "item2" {
  user_ip_id = byteshield_scdn_user_ip.list.id
  ip         = "2.2.2.2"
  remark     = "Second IP"
}
...
output "list_id" {
  value = byteshield_scdn_user_ip.list.id
}

output "item1_id" {
  value = byteshield_scdn_user_ip_item.item1.id
}
