...
resource "byteshield_scdn_security_protection_domain_template" "this" {
...
resource "byteshield_scdn_security_protection_template_batch_config" "this" {
  count = local.apply_batch_config ? 1 : 0

  template_ids = [byteshield_scdn_security_protection_domain_template.this.business_id]
