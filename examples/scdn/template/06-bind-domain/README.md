...
- This example performs the actual bind operation using the `byteshield_scdn_rule_template_domain_bind` resource
...
The `byteshield_scdn_rule_template_domain_bind` resource will:
