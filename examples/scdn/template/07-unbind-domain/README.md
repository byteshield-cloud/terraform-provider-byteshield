...
- This example performs the actual unbind operation using the `byteshield_scdn_rule_template_domain_unbind` resource
...
The `byteshield_scdn_rule_template_domain_unbind` resource will:
