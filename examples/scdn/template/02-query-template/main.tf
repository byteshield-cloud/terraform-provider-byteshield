...
output "template_id" {
  ...
  value       = data.byteshield_scdn_rule_template.example.id
}

output "template_name" {
  description = "Rule template name"
  value       = data.byteshield_scdn_rule_template.example.name
}

output "description" {
  description = "Rule template description"
  value       = data.byteshield_scdn_rule_template.example.description
}

output "created_at" {
  description = "Template creation timestamp"
  value       = data.byteshield_scdn_rule_template.example.created_at
}

output "bind_domains" {
  description = "List of domains bound to this template"
  value       = data.byteshield_scdn_rule_template.example.bind_domains
}
