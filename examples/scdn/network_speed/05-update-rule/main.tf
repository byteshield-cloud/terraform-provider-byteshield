...
variable "rule_id" {
  description = "Rule ID to update (import first: terraform import byteshield_scdn_network_speed_rule.example <business_id>-<business_type>-<config_group>-<rule_id>)"
  type        = number
}
...
output "rule_id" {
  ...
  value       = byteshield_scdn_network_speed_rule.example.id
}
