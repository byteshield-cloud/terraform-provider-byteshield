...
output "domain_proxy_conf" {
  ...
  value       = try(byteshield_scdn_network_speed_config.example.domain_proxy_conf[0], null)
}

output "upstream_redirect" {
  description = "Updated upstream redirect configuration"
  value       = try(byteshield_scdn_network_speed_config.example.upstream_redirect[0], null)
}

output "customized_req_headers" {
  description = "Updated customized request headers configuration"
  value       = try(byteshield_scdn_network_speed_config.example.customized_req_headers[0], null)
}

output "resp_headers" {
  description = "Updated response headers configuration"
  value       = try(byteshield_scdn_network_speed_config.example.resp_headers[0], null)
}

output "upstream_uri_change" {
  description = "Updated upstream URI change configuration"
  value       = try(byteshield_scdn_network_speed_config.example.upstream_uri_change[0], null)
}

output "source_site_protect" {
  description = "Updated source site protection configuration"
  value       = try(byteshield_scdn_network_speed_config.example.source_site_protect[0], null)
}

output "slice" {
  description = "Updated range request configuration"
  value       = try(byteshield_scdn_network_speed_config.example.slice[0], null)
}

output "https_config" {
  description = "Updated HTTPS configuration"
  value       = try(byteshield_scdn_network_speed_config.example.https[0], null)
}

output "page_gzip" {
  description = "Updated page Gzip configuration"
  value       = try(byteshield_scdn_network_speed_config.example.page_gzip[0], null)
}

output "webp" {
  description = "Updated WebP format configuration"
  value       = try(byteshield_scdn_network_speed_config.example.webp[0], null)
}

output "upload_file" {
  description = "Updated upload file configuration"
  value       = try(byteshield_scdn_network_speed_config.example.upload_file[0], null)
}

output "websocket" {
  description = "Updated WebSocket configuration"
  value       = try(byteshield_scdn_network_speed_config.example.websocket[0], null)
}

output "mobile_jump" {
  description = "Updated mobile jump configuration"
  value       = try(byteshield_scdn_network_speed_config.example.mobile_jump[0], null)
}

output "custom_page" {
  description = "Updated custom page configuration"
  value       = try(byteshield_scdn_network_speed_config.example.custom_page[0], null)
}

output "upstream_check" {
  description = "Updated upstream check configuration"
  value       = try(byteshield_scdn_network_speed_config.example.upstream_check[0], null)
}
