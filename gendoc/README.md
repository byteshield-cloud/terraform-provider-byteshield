# ByteShield Provider Documentation Generator

This directory contains the documentation generation tool for the ByteShield Terraform Provider.
...
- `src/provider.md` - Main provider description and resource list
- `src/services/{service}/data_source_en_{name}.md` - Data source descriptions
- `src/services/{service}/resource_en_{name}.md` - Resource descriptions
...
- `website/byteshield.erb` - Sidebar navigation template
...
- `{{.cloud_mark}}` - Provider name (`byteshield`)
- `{{.cloud_title}}` - Provider title (`ByteShield`)
