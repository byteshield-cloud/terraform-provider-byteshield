...
type Product struct {
	...
	ModuleGroups []ModuleGroup `json:"module_groups,omitempty"`
}

// ModuleGroup groups resources and data sources by functional module
...
func GetIndex(content string) ([]Product, error) {
	...
	for _, line := range lines {
		...
		if !strings.HasPrefix(line, "byteshield_") && line != "Data Source" && line != "Resource" {
		...
		if strings.HasPrefix(line, "byteshield_") {
			if currentProduct == nil {
