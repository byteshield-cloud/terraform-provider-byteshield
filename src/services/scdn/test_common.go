...
func getTestConfig() *TestConfig {
	...
	config := &TestConfig{
		AccessKey:              "",
		SecretKey:              "",
		Endpoint:               "https://apiv4.lalcsafe.com",
		TimeoutSeconds:         30,
...
// createTestClient creates a real ByteShieldClient for integration tests
func createTestClient(t *testing.T) *connectivity.ByteShieldClient {
	...
	if err != nil {
		t.Fatalf("Failed to create ByteShieldClient: %v", err)
	}
...
func TestNewScdnService(t *testing.T) {
	client := &connectivity.ByteShieldClient{}
