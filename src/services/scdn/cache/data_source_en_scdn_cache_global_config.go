...
// DataSourceByteShieldScdnCacheGlobalConfig returns the SCDN cache global config data source
func DataSourceByteShieldScdnCacheGlobalConfig() *schema.Resource {
