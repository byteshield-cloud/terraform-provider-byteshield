...
// DataSourceByteShieldScdnCertificatesByDomains returns the SCDN certificates by domains data source
func DataSourceByteShieldScdnCertificatesByDomains() *schema.Resource {
