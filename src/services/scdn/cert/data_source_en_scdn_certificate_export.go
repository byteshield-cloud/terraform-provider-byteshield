...
// DataSourceByteShieldScdnCertificateExport returns the SCDN certificate export data source
func DataSourceByteShieldScdnCertificateExport() *schema.Resource {
