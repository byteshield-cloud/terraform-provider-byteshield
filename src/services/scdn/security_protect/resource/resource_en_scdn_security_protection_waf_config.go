...
// ResourceByteShieldScdnSecurityProtectionWafConfig returns the SCDN security protection WAF config resource
func ResourceByteShieldScdnSecurityProtectionWafConfig() *schema.Resource {
