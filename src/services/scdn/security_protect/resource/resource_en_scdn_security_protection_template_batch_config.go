...
// ResourceByteShieldScdnSecurityProtectionTemplateBatchConfig returns the SCDN security protection template batch config resource
func ResourceByteShieldScdnSecurityProtectionTemplateBatchConfig() *schema.Resource {
