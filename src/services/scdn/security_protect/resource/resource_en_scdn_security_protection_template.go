...
// ResourceByteShieldScdnSecurityProtectionTemplate returns the SCDN security protection template resource
func ResourceByteShieldScdnSecurityProtectionTemplate() *schema.Resource {
