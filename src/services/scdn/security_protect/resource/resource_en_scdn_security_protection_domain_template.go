...
// ResourceByteShieldScdnSecurityProtectionDomainTemplate returns the SCDN security protection domain template resource
...
func ResourceByteShieldScdnSecurityProtectionDomainTemplate() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"template_source_id": {
				...
				Required:    true,
				ForceNew:    true,
				Description: "Source template ID. Use data source byteshield_scdn_security_protection_member_global_template to get the global template ID.",
			},
			// Computed fields
			"business_id": {
				Type:        schema.TypeInt,
