...
// ResourceByteShieldScdnSecurityProtectionDdosConfig returns the SCDN security protection DDoS config resource
func ResourceByteShieldScdnSecurityProtectionDdosConfig() *schema.Resource {
