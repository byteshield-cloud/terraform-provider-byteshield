...
// ResourceByteShieldScdnSecurityProtectionTemplateDomainBind returns the SCDN security protection template domain bind resource
func ResourceByteShieldScdnSecurityProtectionTemplateDomainBind() *schema.Resource {
