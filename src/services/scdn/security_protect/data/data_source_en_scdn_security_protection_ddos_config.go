...
// DataSourceByteShieldScdnSecurityProtectionDdosConfig returns the SCDN security protection DDoS config data source
func DataSourceByteShieldScdnSecurityProtectionDdosConfig() *schema.Resource {
