...
// DataSourceByteShieldScdnSecurityProtectionWafConfig returns the SCDN security protection WAF config data source
func DataSourceByteShieldScdnSecurityProtectionWafConfig() *schema.Resource {
