...
// ResourceByteShieldScdnRuleTemplateDomainBind returns the SCDN rule template domain bind resource
func ResourceByteShieldScdnRuleTemplateDomainBind() *schema.Resource {
