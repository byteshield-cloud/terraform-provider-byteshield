...
// ResourceByteShieldScdnRuleTemplateDomainUnbind returns the SCDN rule template domain unbind resource
func ResourceByteShieldScdnRuleTemplateDomainUnbind() *schema.Resource {
