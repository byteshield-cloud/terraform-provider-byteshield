...
// ResourceByteShieldScdnRuleTemplateSwitch returns the SCDN rule template switch resource
func ResourceByteShieldScdnRuleTemplateSwitch() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"new_tpl_type": {
				...
				ValidateFunc: validation.StringInSlice([]string{"only_domain", "more_domain", "global"}, false),
			},
			// Computed fields
			"id": {
				Type:        schema.TypeString,
