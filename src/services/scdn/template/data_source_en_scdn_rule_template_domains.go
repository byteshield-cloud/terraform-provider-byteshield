...
// DataSourceByteShieldScdnRuleTemplateDomains returns the SCDN rule template domains data source
func DataSourceByteShieldScdnRuleTemplateDomains() *schema.Resource {
