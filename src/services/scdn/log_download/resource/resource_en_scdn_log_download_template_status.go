...
// ResourceByteShieldScdnLogDownloadTemplateStatus returns the SCDN log download template status resource
func ResourceByteShieldScdnLogDownloadTemplateStatus() *schema.Resource {
