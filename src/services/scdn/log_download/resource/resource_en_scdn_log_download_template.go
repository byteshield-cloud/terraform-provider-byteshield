...
// ResourceByteShieldScdnLogDownloadTemplate returns the SCDN log download template resource
func ResourceByteShieldScdnLogDownloadTemplate() *schema.Resource {
