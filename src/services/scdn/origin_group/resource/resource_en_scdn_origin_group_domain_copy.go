...
// ResourceByteShieldScdnOriginGroupDomainCopy returns the SCDN origin group domain copy resource
func ResourceByteShieldScdnOriginGroupDomainCopy() *schema.Resource {
