...
// ResourceByteShieldScdnOriginGroupDomainBind returns the SCDN origin group domain bind resource
func ResourceByteShieldScdnOriginGroupDomainBind() *schema.Resource {
