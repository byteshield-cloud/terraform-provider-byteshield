...
// DataSourceByteShieldScdnDomainBaseSettings returns the SCDN domain base settings data source
func DataSourceByteShieldScdnDomainBaseSettings() *schema.Resource {
