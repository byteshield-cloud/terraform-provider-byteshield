...
import (
	...
	"github.com/byteshield-cloud/terraform-provider-byteshield/src/helper"
	"github.com/byteshield-cloud/terraform-provider-byteshield/src/services/scdn"

	"github.com/hashicorp/terraform-plugin-sdk/v2/helper/schema"
)

// DataSourceByteShieldScdnDomain returns the SCDN domain data source
func DataSourceByteShieldScdnDomain() *schema.Resource {
...
func dataSourceScdnDomainRead(d *schema.ResourceData, m interface{}) error {
	...
	// Set the domain ID as the resource ID (use numeric ID from API, not domain name)
...
// DataSourceByteShieldScdnDomains returns the SCDN domains data source
func DataSourceByteShieldScdnDomains() *schema.Resource {
	return &schema.Resource{
