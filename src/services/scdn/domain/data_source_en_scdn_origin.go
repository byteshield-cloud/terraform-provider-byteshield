...
// DataSourceByteShieldScdnOrigin returns the SCDN origin data source
func DataSourceByteShieldScdnOrigin() *schema.Resource {
...
// DataSourceByteShieldScdnOrigins returns the SCDN origins data source
func DataSourceByteShieldScdnOrigins() *schema.Resource {
	return &schema.Resource{
