...
// DataSourceByteShieldScdnNetworkSpeedConfig returns the SCDN network speed config data source
func DataSourceByteShieldScdnNetworkSpeedConfig() *schema.Resource {
