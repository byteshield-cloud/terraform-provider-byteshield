...
// ResourceByteShieldScdnNetworkSpeedRulesSort returns the SCDN network speed rules sort resource
func ResourceByteShieldScdnNetworkSpeedRulesSort() *schema.Resource {
