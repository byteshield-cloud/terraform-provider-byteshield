...
// DataSourceByteShieldScdnNetworkSpeedRules returns the SCDN network speed rules data source
func DataSourceByteShieldScdnNetworkSpeedRules() *schema.Resource {
