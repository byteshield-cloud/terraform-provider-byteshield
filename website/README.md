...
3. **Open preview page in browser:**
   - Interactive preview: http://localhost:8080/preview.html
     - Features:
       - 📚 All documents organized by category (SCDN)
...
│       ├── scdn_domain.html.markdown
│       └── ...
└── byteshield.erb                    # Sidebar navigation template
```
...
1. Generate docs: `make doc`
2. Commit and push: `git add website/ && git commit -m "docs: update" && git push`
3. Create release tag: `git tag v1.0.0 && git push origin v1.0.0`
4. Terraform Registry will automatically extract docs from `website/` directory

**GitHub Pages**:
1. Generate docs: `make doc`
2. Generate doc list: `cd website && python3 generate_doc_list.py`
3. Configure GitHub Pages in repository settings
4. Deploy via GitHub Actions (see DEPLOYMENT.md for workflow example)
