...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_origin_groups_all"
sidebar_current: "docs-byteshield-datasource-scdn_origin_groups_all"
description: |-
...
output "origin_group_count" {
  value = data.byteshield_scdn_origin_groups_all.example.total
}

output "origin_groups" {
  value = data.byteshield_scdn_origin_groups_all.example.origin_groups
}
```
