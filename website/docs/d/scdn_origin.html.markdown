...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_origin"
sidebar_current: "docs-byteshield-datasource-scdn_origin"
description: |-
...
```hcl
data "byteshield_scdn_origin" "example" {
  origin_id = 12345
  domain_id = 67890
}

output "origin_protocol" {
  value = data.byteshield_scdn_origin.example.protocol
}

output "origin_records" {
  value = data.byteshield_scdn_origin.example.records
}
```
