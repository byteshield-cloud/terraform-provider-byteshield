...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_log_download_tasks"
sidebar_current: "docs-byteshield-datasource-scdn_log_download_tasks"
description: |-
...
```hcl
data "byteshield_scdn_log_download_tasks" "all" {
  page     = 1
  per_page = 20
}

output "task_count" {
  value = data.byteshield_scdn_log_download_tasks.all.total
}

output "tasks" {
  value = data.byteshield_scdn_log_download_tasks.all.tasks
}
```
...
```hcl
data "byteshield_scdn_log_download_tasks" "filtered" {
  page     = 1
  per_page = 20
  search_terms = [
    {
