...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_cache_rules"
sidebar_current: "docs-byteshield-datasource-scdn_cache_rules"
description: |-
...
```hcl
data "byteshield_scdn_cache_rules" "example" {
  business_id   = 12345
  business_type = "tpl"
}

output "rule_count" {
  value = data.byteshield_scdn_cache_rules.example.total
}

output "rules" {
  value = data.byteshield_scdn_cache_rules.example.list
}
```
