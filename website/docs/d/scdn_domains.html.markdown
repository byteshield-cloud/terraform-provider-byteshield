...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_domains"
sidebar_current: "docs-byteshield-datasource-scdn_domains"
description: |-
...
output "domain_count" {
  value = data.byteshield_scdn_domains.all.total
}

output "domain_names" {
  value = [for domain in data.byteshield_scdn_domains.all.domains : domain.domain]
}
```
...
output "filtered_domains" {
  value = data.byteshield_scdn_domains.filtered.domains
}
```
