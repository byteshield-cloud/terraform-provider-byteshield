...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_rule_templates"
sidebar_current: "docs-byteshield-datasource-scdn_rule_templates"
description: |-
...
```hcl
data "byteshield_scdn_rule_templates" "all" {
  page      = 1
  page_size = 100
}

output "template_count" {
  value = data.byteshield_scdn_rule_templates.all.total
}

output "templates" {
  value = data.byteshield_scdn_rule_templates.all.list
}
```
...
```hcl
data "byteshield_scdn_rule_templates" "filtered" {
  page      = 1
  page_size = 100
  name      = "my-template"
...
output "filtered_templates" {
  value = data.byteshield_scdn_rule_templates.filtered.list
}
```
