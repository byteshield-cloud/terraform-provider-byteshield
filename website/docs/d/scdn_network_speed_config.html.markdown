...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_network_speed_config"
sidebar_current: "docs-byteshield-datasource-scdn_network_speed_config"
description: |-
...
output "domain_proxy_conf" {
  value = data.byteshield_scdn_network_speed_config.example.domain_proxy_conf
}
```
