...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_log_download_templates"
sidebar_current: "docs-byteshield-datasource-scdn_log_download_templates"
description: |-
...
```hcl
data "byteshield_scdn_log_download_templates" "all" {
  page     = 1
  per_page = 20
}

output "template_count" {
  value = data.byteshield_scdn_log_download_templates.all.total
}

output "templates" {
  value = data.byteshield_scdn_log_download_templates.all.templates
}
```
...
```hcl
data "byteshield_scdn_log_download_templates" "filtered" {
  page     = 1
  per_page = 20
  search_terms = [
    {
