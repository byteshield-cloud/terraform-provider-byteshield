...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_templates"
sidebar_current: "docs-byteshield-datasource-scdn_security_protection_templates"
description: |-
...
output "template_count" {
  value = data.byteshield_scdn_security_protection_templates.example.total
}

output "templates" {
  value = data.byteshield_scdn_security_protection_templates.example.list
}
```
