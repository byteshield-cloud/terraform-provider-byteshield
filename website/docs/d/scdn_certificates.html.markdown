...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_certificates"
sidebar_current: "docs-byteshield-datasource-scdn_certificates"
description: |-
...
output "certificate_count" {
  value = data.byteshield_scdn_certificates.all.total
}

output "certificates" {
  value = data.byteshield_scdn_certificates.all.list
}
```
...
```hcl
data "byteshield_scdn_certificates" "filtered" {
  page         = 1
  per_page     = 20
  domain       = "example.com"
  binded       = "true"
...
output "filtered_certificates" {
  value = data.byteshield_scdn_certificates.filtered.list
}
```
