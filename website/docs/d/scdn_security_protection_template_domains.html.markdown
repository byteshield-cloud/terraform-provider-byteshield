...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_template_domains"
sidebar_current: "docs-byteshield-datasource-scdn_security_protection_template_domains"
description: |-
...
output "domain_count" {
  value = data.byteshield_scdn_security_protection_template_domains.example.total
}

output "domains" {
  value = data.byteshield_scdn_security_protection_template_domains.example.list
}
```
