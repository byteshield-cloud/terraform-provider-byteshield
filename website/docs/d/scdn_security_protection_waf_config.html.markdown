...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_waf_config"
sidebar_current: "docs-byteshield-datasource-scdn_security_protection_waf_config"
description: |-
...
```hcl
data "byteshield_scdn_security_protection_waf_config" "example" {
  business_id = 12345
}

output "waf_config" {
  value = data.byteshield_scdn_security_protection_waf_config.example.waf_rule_config
}
```
