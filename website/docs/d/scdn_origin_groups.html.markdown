...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_origin_groups"
sidebar_current: "docs-byteshield-datasource-scdn_origin_groups"
description: |-
...
```hcl
data "byteshield_scdn_origin_groups" "all" {
  page      = 1
  page_size = 20
}

output "origin_group_count" {
  value = data.byteshield_scdn_origin_groups.all.total
}

output "origin_groups" {
  value = data.byteshield_scdn_origin_groups.all.origin_groups
}
```
...
```hcl
data "byteshield_scdn_origin_groups" "filtered" {
  name      = "my-group"
  page      = 1
  page_size = 20
}
