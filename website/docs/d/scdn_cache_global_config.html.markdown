...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_cache_global_config"
sidebar_current: "docs-byteshield-datasource-scdn_cache_global_config"
description: |-
...
output "cache_config" {
  value = data.byteshield_scdn_cache_global_config.example.conf
}
```
