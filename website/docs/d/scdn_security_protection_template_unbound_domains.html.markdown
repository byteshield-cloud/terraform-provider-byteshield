...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_template_unbound_domains"
sidebar_current: "docs-byteshield-datasource-scdn_security_protection_template_unbound_domains"
description: |-
...
output "unbound_domain_count" {
  value = data.byteshield_scdn_security_protection_template_unbound_domains.example.total
}

output "unbound_domains" {
  value = data.byteshield_scdn_security_protection_template_unbound_domains.example.list
}
```
