...
sidebar_current: "docs-byteshield-resource-scdn_security_protection_ddos_config"
description: |-
...
```shell
terraform import byteshield_scdn_security_protection_ddos_config.example 12345
```
