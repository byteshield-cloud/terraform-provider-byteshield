...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_log_download_template"
sidebar_current: "docs-byteshield-resource-scdn_log_download_template"
description: |-
...
```hcl
resource "byteshield_scdn_log_download_template" "example" {
...
```shell
terraform import byteshield_scdn_log_download_template.example 12345
```
