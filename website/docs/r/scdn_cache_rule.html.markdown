...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_cache_rule"
sidebar_current: "docs-byteshield-resource-scdn_cache_rule"
description: |-
...
```shell
terraform import byteshield_scdn_cache_rule.example 12345-tpl-67890
```
