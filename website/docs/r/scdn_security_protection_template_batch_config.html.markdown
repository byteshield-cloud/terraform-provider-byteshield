...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_template_batch_config"
sidebar_current: "docs-byteshield-resource-scdn_security_protection_template_batch_config"
description: |-
...
```shell
terraform import byteshield_scdn_security_protection_template_batch_config.example 12345,67890
```
