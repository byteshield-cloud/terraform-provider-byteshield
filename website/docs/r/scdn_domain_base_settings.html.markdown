...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_domain_base_settings"
sidebar_current: "docs-byteshield-resource-scdn_domain_base_settings"
description: |-
...
```hcl
resource "byteshield_scdn_domain_base_settings" "example" {
  domain_id = 12345
...
```shell
terraform import byteshield_scdn_domain_base_settings.example 12345
```
