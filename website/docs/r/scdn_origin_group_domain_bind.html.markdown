...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_origin_group_domain_bind"
sidebar_current: "docs-byteshield-resource-scdn_origin_group_domain_bind"
description: |-
...
```shell
terraform import byteshield_scdn_origin_group_domain_bind.example 12345-67890,11111
```
