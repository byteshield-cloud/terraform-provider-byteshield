...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_cache_rule_status"
sidebar_current: "docs-byteshield-resource-scdn_cache_rule_status"
description: |-
...
```shell
terraform import byteshield_scdn_cache_rule_status.example 12345-tpl-1,2,3
```
