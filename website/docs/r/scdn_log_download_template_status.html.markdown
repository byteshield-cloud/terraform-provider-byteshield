...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_log_download_template_status"
sidebar_current: "docs-byteshield-resource-scdn_log_download_template_status"
description: |-
...
```hcl
resource "byteshield_scdn_log_download_template_status" "example" {
  template_id = 12345
  status      = 1 # 1: enabled
}
```
...
```shell
terraform import byteshield_scdn_log_download_template_status.example 12345
```
