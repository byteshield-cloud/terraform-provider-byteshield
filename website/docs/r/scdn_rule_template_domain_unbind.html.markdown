...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_rule_template_domain_unbind"
sidebar_current: "docs-byteshield-resource-scdn_rule_template_domain_unbind"
description: |-
...
```hcl
resource "byteshield_scdn_rule_template_domain_unbind" "example" {
  template_id = 12345
...
```shell
terraform import byteshield_scdn_rule_template_domain_unbind.example 12345-67890,11111
```
