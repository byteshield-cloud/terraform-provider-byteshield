...
sidebar_current: "docs-byteshield-resource-scdn_security_protection_waf_config"
description: |-
...
```shell
terraform import byteshield_scdn_security_protection_waf_config.example 12345
```
