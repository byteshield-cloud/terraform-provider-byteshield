...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_certificate"
sidebar_current: "docs-byteshield-resource-scdn_certificate"
description: |-
...
```shell
terraform import byteshield_scdn_certificate.example 12345
```
