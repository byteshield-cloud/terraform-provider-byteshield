...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_network_speed_rule"
sidebar_current: "docs-byteshield-resource-scdn_network_speed_rule"
description: |-
...
```shell
terraform import byteshield_scdn_network_speed_rule.example 12345-tpl-custom_page-67890
```
