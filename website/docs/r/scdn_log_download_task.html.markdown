...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_log_download_task"
sidebar_current: "docs-byteshield-resource-scdn_log_download_task"
description: |-
...
```hcl
resource "byteshield_scdn_log_download_task" "example" {
  template_id = 12345
...
```shell
terraform import byteshield_scdn_log_download_task.example 12345
```
