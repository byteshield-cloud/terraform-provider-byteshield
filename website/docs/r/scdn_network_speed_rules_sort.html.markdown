...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_network_speed_rules_sort"
sidebar_current: "docs-byteshield-resource-scdn_network_speed_rules_sort"
description: |-
...
```hcl
resource "byteshield_scdn_network_speed_rules_sort" "example" {
  business_id   = 12345
  business_type = "tpl"
...
```shell
terraform import byteshield_scdn_network_speed_rules_sort.example 12345-tpl-custom_page
```
