...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_domain_node_switch"
sidebar_current: "docs-byteshield-resource-scdn_domain_node_switch"
description: |-
...
```shell
terraform import byteshield_scdn_domain_node_switch.example 12345
```
