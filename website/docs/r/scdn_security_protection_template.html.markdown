...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_security_protection_template"
sidebar_current: "docs-byteshield-resource-scdn_security_protection_template"
description: |-
...
```shell
terraform import byteshield_scdn_security_protection_template.example 12345
```
