...
layout: "byteshield"
page_title: "ByteShield: byteshield_scdn_origin_group"
sidebar_current: "docs-byteshield-resource-scdn_origin_group"
description: |-
...
```shell
terraform import byteshield_scdn_origin_group.example 12345
```
